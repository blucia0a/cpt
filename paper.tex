...
of the interaction, which leads to the failure.  
...
how last writer slices are useful for debugging.
...
definitely helpful in one case where last writer slices is useful and may help
...
\section{Conclusions}
Last writer slices are the first system to collect a general form of data provenance information for concurrent programs with overheads low enough for production use. 
