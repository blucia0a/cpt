...
{\bf App} & {\bf Type} & {\bf Eff.?} & {\bf Triv.?} & {\bf Usef.?} \\ \hline
mysql   & Atom.  &Yes  &No & Yes    \\
pbzip2  & Order  &Yes  &No & Yes    \\
httrack & Order  &Yes  &No & Yes    \\
jdk-sb  & Atom.  &Yes  &No & Yes    \\
apache1 & Atom.  &Yes  &No & Yes    \\ 
apache2 & Atom.  &Yes  &No & Maybe  \\
\end{tabular}
\caption{{\bf Evaluation of debugging with last writer slices.} We describe each bug and summarize the debugging benefit of last writer slices using the evaluation criteria from ~\cite{badapples}.}
\end{table}
