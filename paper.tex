...
work~\cite{whylinechi,whylineicse} community showed that when programmers debug
...
picture.  However, Thread 2 may have completed its erase operation and moved on
...
{\bf TODO: Replace with the "fixed" version of the JDK figure (currently in eval).  Update the text to match the new figure.}
...
{\bf TODO: Move this to Section 3 where it will live.}
\begin{figure}[h]
\centering
