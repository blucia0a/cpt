...
In our evaluation, we show how last writer slicing

 and \ctraps are used to 
efficiently two concurrency analyses from prior work. 
...
show \ctraps is useful by implementing .  We evaluate the performance of our designs using server programs
